...
protocol Series30DiasViewModel: ObservableObject
{
    func getSeries30Dias() async
}

@MainActor
final class Series30DiasViewModelImpl: Series30DiasViewModel
{
    enum State
    {
        case na
    ...
    func getSeries30Dias() async
    {
        ...
        let result = await service.getSeries30dias()
        switch result
        {
